...
function smtpmail($mail_to, $subject, $message, $headers='') {
        ...
        //Настройки почты
        $config['smtp_username'] = 'ask@metodissimo.ru';  //Смените на имя своего почтового ящика из ISPManager.
        $config['smtp_password'] = 'olga1979';  //Измените пароль.
        $config['smtp_from']     = 'Ольга'; //Ваше имя - или имя Вашего сайта. Будет показывать при прочтении в поле "От кого".
